...
class MoleculeVocab:
    ...
    def __init__(self, use_small_mol=False):
...
if "EPT_VOCAB" in os.environ.keys() and os.environ["EPT_VOCAB"]==1:
    VOCAB = MoleculeVocab(use_small_mol=True)
else:
    VOCAB = MoleculeVocab()
...
class Block:
    ...
    def from_tuple(self, data):
        return Block(
            ...
            properties=data[3] if len(data) == 4 else None
        )
